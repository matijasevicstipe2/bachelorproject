...
-- Inserting a personal trainer with profile picture
INSERT INTO personal_trainers (id, firstname, lastname, age, email, availability, gym_id, speciality, profile_picture)
VALUES (1, 'John', 'Doe', 30, 'john.doe@example.com', true, 1, 'Strength Training', {binary_data});

-- Inserting a personal trainer without profile picture
