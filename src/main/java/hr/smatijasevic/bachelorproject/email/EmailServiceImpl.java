...
public class EmailServiceImpl implements EmailService {
    private static final String TEST_EMAIL = "powerhousefitness904@gmail.com";
    private final Gmail service;
    public EmailServiceImpl() throws GeneralSecurityException, IOException {
        NetHttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
        GsonFactory jsonFactory = GsonFactory.getDefaultInstance();
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("Bachelor Project")
                .build();
    }
    ...
    @Override
    public void sendEmailQRCode(String to, String subject, String message, byte[] qrCodeBytes) throws MessagingException, IOException {
        Properties props = new Properties();
        Session session = Session.getDefaultInstance(props, null);
        MimeMessage email = new MimeMessage(session);
        email.setFrom(new InternetAddress(TEST_EMAIL));
        ...
        ByteArrayDataSource qrCodeDataSource = new ByteArrayDataSource(qrCodeBytes, "image/png");
        imagePart.setDataHandler(new DataHandler(qrCodeDataSource));
        imagePart.setHeader("Content-ID", "<qr-code-image>");
